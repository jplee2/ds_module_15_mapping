...
function createMap(data, geo_data) {
    ...
    legend.onAdd = function() {
      ...
      legendInfo += "<i style='background: #98EE00'></i>-10-10<br></br>";
      legendInfo += "<i style='background: #D4EE00'></i>10-30<br></br>";
      legendInfo += "<i style='background: #EECC00'></i>30-50<br></br>";
      legendInfo += "<i style='background: #EE9C00'></i>-50-70<br></br>";
      legendInfo += "<i style='background: #EA822C'></i>-70-90<br></br>";
      legendInfo += "<i style='background: #EA2C2C'></i>90+<br></br>";
